...
const PROJECT_DATA = [
  ...
  , {id: 'workTime'             , desc: 'Durée de travail accomplie'  , type: 'integer' , default: 0      , editable: true} 
  ...
  , {id: 'collapsed'            , desc: 'Mise en stanbdy du projet'   , type: 'boolean' , default: false  , editable: true}
