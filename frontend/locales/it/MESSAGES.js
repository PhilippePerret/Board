...
const MESSAGES = {
    ...
    , 'select-all-tooltip': "Seleziona tutto"
    , 'select-none-tooltip': "Deseleziona tutto"
    ...
    , 'View': "Mostra"
    , 'app-launching': "Inizializzazione dell'applicazione…"
    , 'init-projects-services-and-reminders': "Inizializzazione di progetti, servizi e promemoria…"
    , 'app-backup-running': "Backup di sicurezza…"
    , 'app-ready': "Applicazione pronta."
    , 'app-backup-discrepancy-title': "Grande discrepanza di dati"
    , 'app-backup-discrepancy-intro': "Grande discrepanza di dati:"
    , 'app-backup-projects-diff': "$1 progetto$3 prima, $2 ora"
    , 'app-backup-services-diff': "$1 servizio$3 prima, $2 ora"
    , 'app-backup-confirm-btn': "Confermo"
    , 'app-backup-restore-btn': "Ripristina il backup precedente"
    , 'github-pr-cycle-confirming-init': "Conferma dell'inizializzazione."
    , 'github-pr-cycle-confirm-init': "Sei sicuro di voler avviare questo ciclo PR Github?\n\nUn nuovo branch di sviluppo verrà creato a partire da main."
    , 'github-pr-cycle-init': "Ciclo PR Github – Avvia"
    , 'github-pr-cycle-commit': "Ciclo PR Github – Commit"
    , 'github-pr-cycle-submit': "Ciclo PR Github – Invia"
    , 'github-pr-cycle-confirming-submit': "Conferma dell'invio."
    , 'github-pr-cycle-confirm-submit': "Sei sicuro di voler confermare l'invio dei file committati per generare una Pull Request Github?\n\nMolto probabilmente questa PR avvierà un'esecuzione di test (Github Action) e forse un aggiornamento del sito o dell'applicazione. Conferma quindi con cognizione di causa."
    , 'github-pr-cycle-submission-ok': "Invio della Pull Request effettuato con successo!"
    , 'github-pr-cycle-branch-name': "Nome del branch di sviluppo da creare"
    , 'github-pr-cycle-commit-title': "Titolo di questo commit"
    , 'github-pr-cycle-commit-body': "Corpo del testo di questo commit (può restare vuoto)"
    , 'github-pr-cycle-inited': "Ciclo PR Github avviato per $1."
    , 'git-pr-cycle-branche': "Nome del branch di un ciclo PR Github."
    , 'git-title-conflict-errors-section': "<div class=title>Problemi di conflitto</div>"
    , 'git-title-syntax-errors-section': "<div class=title>Problemi di sintassi rilevati</div>"
    , 'github-repo-visibility': "Visibilità del nuovo repository"
    , 'github-repo-visibility-q': "Questo repository Github non esiste ancora: verrà creato. Quale visibilità vuoi assegnargli?"
    , 'Private': "Privato"
    , 'Public': "Pubblico"
