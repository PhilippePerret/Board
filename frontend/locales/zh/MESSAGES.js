...
const MESSAGES = {
    ...
    , 'action-on-checked-issues': "选择要处理的 issue 并选择操作。"
    , 'gh-close': "关闭/删除"
    , 'gh-comment': "评论"
    , 'gh-pin': '置顶'
    , 'gh-unpin': '取消置顶'
    ...
    , 'View': "查看"
    , 'app-launching': "正在初始化应用程序…"
    , 'init-projects-services-and-reminders': "正在初始化项目、服务和提醒…"
    , 'app-backup-running': "正在进行安全备份…"
    , 'app-ready': "应用程序已就绪。"
    , 'app-backup-discrepancy-title': "数据差异较大"
    , 'app-backup-discrepancy-intro': "数据差异较大："
    , 'app-backup-projects-diff': "之前 $1 个项目，现在 $2 个"
    , 'app-backup-services-diff': "之前 $1 个服务，现在 $2 个"
    , 'app-backup-confirm-btn': "我确认"
    , 'app-backup-restore-btn': "恢复到之前的备份"
    , 'github-pr-cycle-confirming-init': "确认初始化。"
    , 'github-pr-cycle-confirm-init': "确定要启动这个 Github PR 周期吗？\n\n将从 main 创建一个新的开发分支。"
    , 'github-pr-cycle-init': "Github PR 周期 – 初始化"
    , 'github-pr-cycle-commit': "Github PR 周期 – 提交"
    , 'github-pr-cycle-submit': "Github PR 周期 – 提交请求"
    , 'github-pr-cycle-confirming-submit': "确认提交。"
    , 'github-pr-cycle-confirm-submit': "确定要确认提交已提交的文件以生成 Github Pull Request 吗？\n\n这很可能会触发测试运行（Github Action），并可能导致网站或应用程序更新。请在充分了解情况后确认。"
    , 'github-pr-cycle-submission-ok': "Pull Request 提交成功！"
    , 'github-pr-cycle-branch-name': "要创建的开发分支名称"
    , 'github-pr-cycle-commit-title': "此提交的标题"
    , 'github-pr-cycle-commit-body': "此提交的正文（可留空）"
    , 'github-pr-cycle-inited': "Github PR 周期已为 $1 初始化。"
    , 'git-pr-cycle-branche': "Github PR 周期的分支名称。"
    , 'git-title-conflict-errors-section': "<div class=title>冲突问题</div>"
    , 'git-title-syntax-errors-section': "<div class=title>检测到语法问题</div>"
    , 'github-repo-visibility': "新仓库的可见性"
    , 'github-repo-visibility-q': "这个 Github 仓库还不存在：即将创建。您希望赋予它什么可见性？"
    , 'Private': "私有"
    , 'Public': "公开"
