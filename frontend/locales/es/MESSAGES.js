...
const MESSAGES = {
    ...
    , 'action-on-checked-issues': "Selecciona las issues a tratar y elige la acción."
    ...
    , 'View': "Mostrar"
    , 'app-launching': "Inicializando la aplicación…"
    , 'init-projects-services-and-reminders': "Inicializando proyectos, servicios y recordatorios…"
    , 'app-backup-running': "Copia de seguridad…"
    , 'app-ready': "Aplicación lista."
    , 'app-backup-discrepancy-title': "Gran discrepancia de datos"
    , 'app-backup-discrepancy-intro': "Gran discrepancia de datos:"
    , 'app-backup-projects-diff': "$1 proyecto$3 antes, $2 ahora"
    , 'app-backup-services-diff': "$1 servicio$3 antes, $2 ahora"
    , 'app-backup-confirm-btn': "Confirmo"
    , 'app-backup-restore-btn': "Volver a la copia de seguridad anterior"
    , 'github-pr-cycle-confirming-init': "Confirmación de la inicialización."
    , 'github-pr-cycle-confirm-init': "¿Está seguro de que desea iniciar este ciclo de PR de Github?\n\nSe creará una nueva rama de desarrollo a partir de main."
    , 'github-pr-cycle-init': "Ciclo de PR de Github – Iniciar"
    , 'github-pr-cycle-commit': "Ciclo de PR de Github – Confirmar cambios"
    , 'github-pr-cycle-submit': "Ciclo de PR de Github – Enviar"
    , 'github-pr-cycle-confirming-submit': "Confirmación del envío."
    , 'github-pr-cycle-confirm-submit': "¿Está seguro de confirmar el envío de los archivos confirmados para generar una Pull Request de Github?\n\nMuy probablemente, esta PR desencadenará una ejecución de pruebas (Github Action) y quizás una actualización del sitio o de la aplicación. Confirme con conocimiento de causa."
    , 'github-pr-cycle-submission-ok': "¡Envío de la Pull Request realizado con éxito!"
    , 'github-pr-cycle-branch-name': "Nombre de la rama de desarrollo a crear"
    , 'github-pr-cycle-commit-title': "Título de este commit"
    , 'github-pr-cycle-commit-body': "Cuerpo de texto de este commit (puede quedar vacío)"
    , 'github-pr-cycle-inited': "Ciclo de PR de Github iniciado para $1."
    , 'git-pr-cycle-branche': "Nombre de la rama de un ciclo de PR de Github."
    , 'git-title-conflict-errors-section': "<div class=title>Problemas de conflicto</div>"
    , 'git-title-syntax-errors-section': "<div class=title>Problemas de sintaxis detectados</div>"
    , 'github-repo-visibility': "Visibilidad del nuevo repositorio"
    , 'github-repo-visibility-q': "Este repositorio de Github aún no existe: se va a crear. ¿Qué visibilidad desea darle?"
    , 'Private': "Privado"
    , 'Public': "Público"
