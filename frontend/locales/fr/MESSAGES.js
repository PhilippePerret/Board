...
const MESSAGES = {
    ...
    , 'github-pr-cycle-confirming-init': "Confirmation de l'initialisation."
    , 'github-pr-cycle-confirm-init': "Êtes-vous sûr de vouloir initier ce cycle PR Github ?\n\nUne nouvelle branche de développement va être créée à partir de main."
    ...
    , 'github-repo-visibility': "Visibilité du nouveau dépôt"
    , 'github-repo-visibility-q': "Ce dépôt Github n'existe pas encore : il va être créé. Quelle visibilité souhaitez-vous lui donner ?"
    , 'Private': "Privé"
    , 'Public': "Public"
    , 'github-repo-checking': "Vérification du dépôt Github…"
}