...
const MESSAGES = {
    ...
    , 'select-none-tooltip': "Deselect all"
    ...
    , 'action-on-checked-issues': "Select the issues to process and choose the action."
    ...
    , 'View': "Show"
    , 'app-launching': "Initializing the application…"
    , 'init-projects-services-and-reminders': "Initializing projects, services, and reminders…"
    , 'app-backup-running': "Safety backup…"
    , 'app-ready': "Application ready."
    , 'app-backup-discrepancy-title': "Large data discrepancy"
    , 'app-backup-discrepancy-intro': "Large data discrepancy:"
    , 'app-backup-projects-diff': "$1 project$3 previously, $2 now"
    , 'app-backup-services-diff': "$1 service$3 previously, $2 now"
    , 'app-backup-confirm-btn': "I confirm"
    , 'app-backup-restore-btn': "Revert to previous backup"
    , 'github-pr-cycle-confirming-init': "Confirming initialization."
    , 'github-pr-cycle-confirm-init': "Are you sure you want to initiate this Github PR Cycle?\n\nA new development branch will be created from main."
    , 'github-pr-cycle-init': "Github PR Cycle – Initiate"
    , 'github-pr-cycle-commit': "Github PR Cycle – Commit"
    , 'github-pr-cycle-submit': "Github PR Cycle – Submit"
    , 'github-pr-cycle-confirming-submit': "Confirming submission."
    , 'github-pr-cycle-confirm-submit': "Are you sure you want to confirm the submission of the committed files to generate a Github Pull Request?\n\nThis will very likely trigger a test run (Github Action) and possibly a site or application update. Please confirm knowingly."
    , 'github-pr-cycle-submission-ok': "Pull Request submission completed successfully!"
    , 'github-pr-cycle-branch-name': "Name of the development branch to create"
    , 'github-pr-cycle-commit-title': "Title of this commit"
    , 'github-pr-cycle-commit-body': "Body text of this commit (can be left empty)"
    , 'github-pr-cycle-inited': "Github PR Cycle initiated for $1."
    , 'git-pr-cycle-branche': "Name of the branch for a Github PR Cycle."
    , 'git-title-conflict-errors-section': "<div class=title>Conflict issues</div>"
    , 'git-title-syntax-errors-section': "<div class=title>Syntax issues detected</div>"
    , 'github-repo-visibility': "Visibility of the new repository"
    , 'github-repo-visibility-q': "This Github repository doesn't exist yet: it will be created. What visibility do you want to give it?"
    , 'Private': "Private"
    , 'Public': "Public"
