...
**Précision 2026-08-09** : "normalement, corrigé" n'est pas une formule à utiliser partout par défaut. Sur un edit mécanique simple et certain (ex. ajouter un clic pour fermer une fenêtre), dire juste "Corrigé." — "normalement" n'a de sens que pour un fix incertain (diagnostic complexe pas encore vérifié par un run réel). Employer "normalement" sur du trivial revient à douter sans raison de sa propre capacité à faire une tâche simple, ce que Phil distingue nettement d'une prédiction incertaine légitime.
