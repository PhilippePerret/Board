---
name: stop-repeating-not-compiled-tested
description: ne pas répéter "pas compilé, pas testé" après chaque edit de code
metadata:
  type: feedback
---

Ne pas ajouter systématiquement "écrit, pas compilé, pas testé" (ou variante) à la fin d'une réponse après une modification de code.
