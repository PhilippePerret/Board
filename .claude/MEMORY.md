...
- PRIORITÉ : [État fin de session 2026-07-30](2026-07-30-Etat-fin-de-session.md) — reprise diagnostic échec test création projet (getInfoFinderSelection.scpt lent), lancer run-tests
