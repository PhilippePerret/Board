...
- PRIORITÉ — [État fin de session 2026-07-18](2026-07-18-Etat-fin-de-session.md) — session close sans échec connu restant, contexte utile (debug log, entrée run-tests) à lire avant de repartir sur les tests
