...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.4.0/arm64-darwin25")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/private/tmp/claude-501/-Users-philippeperret-Programmes-Board/d351cfaf-b58b-45a2-8e05-19c0bb2b73fa/scratchpad/ruby-relocatable")
  ...
  CONFIG["configure_args"] = " '--prefix=/private/tmp/claude-501/-Users-philippeperret-Programmes-Board/d351cfaf-b58b-45a2-8e05-19c0bb2b73fa/scratchpad/ruby-relocatable' '--with-openssl-dir=/opt/homebrew/opt/openssl@3' '--enable-shared' '--with-libyaml-dir=/opt/homebrew/opt/libyaml' '--with-gmp-dir=/opt/homebrew/opt/gmp' '--with-ext=openssl,psych,+' '--enable-load-relative' '--disable-install-doc' 'CC=clang' 'LDFLAGS=-L/opt/homebrew/opt/poppler-qt5/lib' 'CPPFLAGS=-I/opt/homebrew/opt/poppler-qt5/include'"
  ...
  CONFIG["DLDFLAGS"] = "-L/opt/homebrew/opt/poppler-qt5/lib -L/opt/homebrew/Cellar/gmp/6.3.0/lib -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/homebrew/opt/poppler-qt5/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/opt/homebrew/opt/poppler-qt5/lib -fstack-protector-strong -L/opt/homebrew/Cellar/gmp/6.3.0/lib"
  ...
  CONFIG["wasmoptflags"] = ""
  CONFIG["WASMOPT"] = ""
  CONFIG["config_target"] = "aarch64-apple-darwin25.6.0"
  ...
  CONFIG["host"] = "$(target)"
  CONFIG["build_os"] = "darwin25.6.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "aarch64"
  CONFIG["build"] = "aarch64-apple-darwin25.6.0"
